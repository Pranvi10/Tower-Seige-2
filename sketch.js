...
function draw() {
  ...
  strokeWeight(4);
  textSize(30);
  text("Drag the hexagonal stone and release it to launch it towards the tower blocks to destroy them.", 80, 50);
  pop();
  ...
  strokeWeight(4);
  textSize(30);
  text("Press space key to get second chance!!", 700, 500);
  pop();
